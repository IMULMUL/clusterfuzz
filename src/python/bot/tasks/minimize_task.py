...
def run_libfuzzer_engine(tool_name, target_name, arguments, testcase_path,
  ...
  if environment.is_trusted_host():
    ...
    return tasks_host.process_testcase(tool_name, target_name, arguments,
...
def _run_libfuzzer_tool(tool_name,
  ...
  arguments = environment.get_value('APP_ARGS', '').split()
  try:
    # TODO(ochang): Move this somewhere better/share logic with
    # data_handler.get_arguments().
    arguments.remove('%TESTCASE%')
  except:
    pass
