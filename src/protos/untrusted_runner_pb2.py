...
_PROCESSTESTCASEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='operation', full_name='ProcessTestcaseRequest.operation', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='target_name', full_name='ProcessTestcaseRequest.target_name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='arguments', full_name='ProcessTestcaseRequest.arguments', index=2,
      number=3, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='testcase_path', full_name='ProcessTestcaseRequest.testcase_path', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='output_path', full_name='ProcessTestcaseRequest.output_path', index=4,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timeout', full_name='ProcessTestcaseRequest.timeout', index=5,
...
_PROCESSTESTCASERESPONSE = _descriptor.Descriptor(
  name='ProcessTestcaseResponse',
  full_name='ProcessTestcaseResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='return_code', full_name='ProcessTestcaseResponse.return_code', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='time_executed', full_name='ProcessTestcaseResponse.time_executed', index=1,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='output', full_name='ProcessTestcaseResponse.output', index=2,
      number=3, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['ProcessTestcaseResponse'] = _PROCESSTESTCASERESPONSE
...
ProcessTestcaseResponse = _reflection.GeneratedProtocolMessageType('ProcessTestcaseResponse', (_message.Message,), dict(
  DESCRIPTOR = _PROCESSTESTCASERESPONSE,
  __module__ = 'untrusted_runner_pb2'
  # @@protoc_insertion_point(class_scope:ProcessTestcaseResponse)
  ))
_sym_db.RegisterMessage(ProcessTestcaseResponse)
...
_UNTRUSTEDRUNNER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=_PROCESSTESTCASERESPONSE,
    serialized_options=None,
  ),
])
