...
class UntrustedRunnerStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetStatus = channel.unary_unary(
        ...
        request_serializer=untrusted__runner__pb2.GetStatusRequest.SerializeToString,
        response_deserializer=untrusted__runner__pb2.GetStatusResponse.FromString,
        )
    ...
    self.RunProcess = channel.unary_unary(
        ...
        response_deserializer=untrusted__runner__pb2.RunProcessResponse.FromString,
        )
    self.RunAndWait = channel.unary_unary(
        '/UntrustedRunner/RunAndWait',
        request_serializer=untrusted__runner__pb2.RunAndWaitRequest.SerializeToString,
        response_deserializer=untrusted__runner__pb2.RunAndWaitResponse.FromString,
        )
    self.CreateDirectory = channel.unary_unary(
        '/UntrustedRunner/CreateDirectory',
        request_serializer=untrusted__runner__pb2.CreateDirectoryRequest.SerializeToString,
        response_deserializer=untrusted__runner__pb2.CreateDirectoryResponse.FromString,
        )
    self.RemoveDirectory = channel.unary_unary(
        '/UntrustedRunner/RemoveDirectory',
        request_serializer=untrusted__runner__pb2.RemoveDirectoryRequest.SerializeToString,
        response_deserializer=untrusted__runner__pb2.RemoveDirectoryResponse.FromString,
        )
    self.ListFiles = channel.unary_unary(
        '/UntrustedRunner/ListFiles',
        request_serializer=untrusted__runner__pb2.ListFilesRequest.SerializeToString,
        response_deserializer=untrusted__runner__pb2.ListFilesResponse.FromString,
        )
    self.CopyFileTo = channel.stream_unary(
        '/UntrustedRunner/CopyFileTo',
        request_serializer=untrusted__runner__pb2.FileChunk.SerializeToString,
        response_deserializer=untrusted__runner__pb2.CopyFileToResponse.FromString,
        )
    self.CopyFileFrom = channel.unary_stream(
        '/UntrustedRunner/CopyFileFrom',
        request_serializer=untrusted__runner__pb2.CopyFileFromRequest.SerializeToString,
        response_deserializer=untrusted__runner__pb2.FileChunk.FromString,
        )
    self.Stat = channel.unary_unary(
        '/UntrustedRunner/Stat',
        request_serializer=untrusted__runner__pb2.StatRequest.SerializeToString,
        response_deserializer=untrusted__runner__pb2.StatResponse.FromString,
        )
    self.UpdateEnvironment = channel.unary_unary(
        '/UntrustedRunner/UpdateEnvironment',
        request_serializer=untrusted__runner__pb2.UpdateEnvironmentRequest.SerializeToString,
        response_deserializer=untrusted__runner__pb2.UpdateEnvironmentResponse.FromString,
        )
    self.ResetEnvironment = channel.unary_unary(
        '/UntrustedRunner/ResetEnvironment',
        request_serializer=untrusted__runner__pb2.ResetEnvironmentRequest.SerializeToString,
        response_deserializer=untrusted__runner__pb2.ResetEnvironmentResponse.FromString,
        )
    self.UpdateSource = channel.unary_unary(
        '/UntrustedRunner/UpdateSource',
        request_serializer=untrusted__runner__pb2.UpdateSourceRequest.SerializeToString,
        response_deserializer=untrusted__runner__pb2.UpdateSourceResponse.FromString,
        )
    self.SymbolizeStacktrace = channel.unary_unary(
        '/UntrustedRunner/SymbolizeStacktrace',
        request_serializer=untrusted__runner__pb2.SymbolizeStacktraceRequest.SerializeToString,
        response_deserializer=untrusted__runner__pb2.SymbolizeStacktraceResponse.FromString,
        )
    self.TerminateStaleApplicationInstances = channel.unary_unary(
        '/UntrustedRunner/TerminateStaleApplicationInstances',
        request_serializer=untrusted__runner__pb2.TerminateStaleApplicationInstancesRequest.SerializeToString,
        response_deserializer=untrusted__runner__pb2.TerminateStaleApplicationInstancesResponse.FromString,
        )
    self.GetFuzzTargets = channel.unary_unary(
        '/UntrustedRunner/GetFuzzTargets',
        request_serializer=untrusted__runner__pb2.GetFuzzTargetsRequest.SerializeToString,
        response_deserializer=untrusted__runner__pb2.GetFuzzTargetsResponse.FromString,
        )
    self.PruneCorpus = channel.unary_unary(
        '/UntrustedRunner/PruneCorpus',
        request_serializer=untrusted__runner__pb2.PruneCorpusRequest.SerializeToString,
        response_deserializer=untrusted__runner__pb2.PruneCorpusResponse.FromString,
        )
...
def add_UntrustedRunnerServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'GetStatus': grpc.unary_unary_rpc_method_handler(
          servicer.GetStatus,
          request_deserializer=untrusted__runner__pb2.GetStatusRequest.FromString,
          response_serializer=untrusted__runner__pb2.GetStatusResponse.SerializeToString,
      ),
      ...
      'RunProcess': grpc.unary_unary_rpc_method_handler(
          servicer.RunProcess,
          request_deserializer=untrusted__runner__pb2.RunProcessRequest.FromString,
          response_serializer=untrusted__runner__pb2.RunProcessResponse.SerializeToString,
      ),
      'RunAndWait': grpc.unary_unary_rpc_method_handler(
          servicer.RunAndWait,
          request_deserializer=untrusted__runner__pb2.RunAndWaitRequest.FromString,
          response_serializer=untrusted__runner__pb2.RunAndWaitResponse.SerializeToString,
      ),
      'CreateDirectory': grpc.unary_unary_rpc_method_handler(
          servicer.CreateDirectory,
          request_deserializer=untrusted__runner__pb2.CreateDirectoryRequest.FromString,
          response_serializer=untrusted__runner__pb2.CreateDirectoryResponse.SerializeToString,
      ),
      'RemoveDirectory': grpc.unary_unary_rpc_method_handler(
          servicer.RemoveDirectory,
          request_deserializer=untrusted__runner__pb2.RemoveDirectoryRequest.FromString,
          response_serializer=untrusted__runner__pb2.RemoveDirectoryResponse.SerializeToString,
      ),
      'ListFiles': grpc.unary_unary_rpc_method_handler(
          servicer.ListFiles,
          request_deserializer=untrusted__runner__pb2.ListFilesRequest.FromString,
          response_serializer=untrusted__runner__pb2.ListFilesResponse.SerializeToString,
      ),
      'CopyFileTo': grpc.stream_unary_rpc_method_handler(
          servicer.CopyFileTo,
          request_deserializer=untrusted__runner__pb2.FileChunk.FromString,
          response_serializer=untrusted__runner__pb2.CopyFileToResponse.SerializeToString,
      ),
      'CopyFileFrom': grpc.unary_stream_rpc_method_handler(
          servicer.CopyFileFrom,
          request_deserializer=untrusted__runner__pb2.CopyFileFromRequest.FromString,
          response_serializer=untrusted__runner__pb2.FileChunk.SerializeToString,
      ),
      'Stat': grpc.unary_unary_rpc_method_handler(
          servicer.Stat,
          request_deserializer=untrusted__runner__pb2.StatRequest.FromString,
          response_serializer=untrusted__runner__pb2.StatResponse.SerializeToString,
      ),
      'UpdateEnvironment': grpc.unary_unary_rpc_method_handler(
          servicer.UpdateEnvironment,
          request_deserializer=untrusted__runner__pb2.UpdateEnvironmentRequest.FromString,
          response_serializer=untrusted__runner__pb2.UpdateEnvironmentResponse.SerializeToString,
      ),
      'ResetEnvironment': grpc.unary_unary_rpc_method_handler(
          servicer.ResetEnvironment,
          request_deserializer=untrusted__runner__pb2.ResetEnvironmentRequest.FromString,
          response_serializer=untrusted__runner__pb2.ResetEnvironmentResponse.SerializeToString,
      ),
      'UpdateSource': grpc.unary_unary_rpc_method_handler(
          servicer.UpdateSource,
          request_deserializer=untrusted__runner__pb2.UpdateSourceRequest.FromString,
          response_serializer=untrusted__runner__pb2.UpdateSourceResponse.SerializeToString,
      ),
      'SymbolizeStacktrace': grpc.unary_unary_rpc_method_handler(
          servicer.SymbolizeStacktrace,
          request_deserializer=untrusted__runner__pb2.SymbolizeStacktraceRequest.FromString,
          response_serializer=untrusted__runner__pb2.SymbolizeStacktraceResponse.SerializeToString,
      ),
      'TerminateStaleApplicationInstances': grpc.unary_unary_rpc_method_handler(
          servicer.TerminateStaleApplicationInstances,
          request_deserializer=untrusted__runner__pb2.TerminateStaleApplicationInstancesRequest.FromString,
          response_serializer=untrusted__runner__pb2.TerminateStaleApplicationInstancesResponse.SerializeToString,
      ),
      'GetFuzzTargets': grpc.unary_unary_rpc_method_handler(
          servicer.GetFuzzTargets,
          request_deserializer=untrusted__runner__pb2.GetFuzzTargetsRequest.FromString,
          response_serializer=untrusted__runner__pb2.GetFuzzTargetsResponse.SerializeToString,
      ),
      'PruneCorpus': grpc.unary_unary_rpc_method_handler(
          servicer.PruneCorpus,
          request_deserializer=untrusted__runner__pb2.PruneCorpusRequest.FromString,
          response_serializer=untrusted__runner__pb2.PruneCorpusResponse.SerializeToString,
      ),
